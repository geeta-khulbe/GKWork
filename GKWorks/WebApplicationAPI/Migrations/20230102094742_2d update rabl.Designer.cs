...
namespace WebApplicationAPI.Migrations
{
    ...
    [Migration("20230102094742_2d update rabl")]
    partial class _2dupdaterabl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplicationAPI.Models.Domain.Walk", b =>
                {
                    b.HasOne("WebApplicationAPI.Models.Domain.Region", "Region")
                        .WithMany("Walks")
                        .HasForeignKey("RegionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplicationAPI.Models.Domain.WalkDifficulty", "WalkDifficulty")
                        .WithMany()
